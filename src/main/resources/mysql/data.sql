INSERT INTO obiekt_rekreacyjno_sportowy.uzytkownik(id, nazwa_uzytkownika, haslo, poziom_dostepu, numer_telefonu,created)
VALUES('1','admin','$2a$04$KWeGmrnv.s7rn/zWFN4p/emjZDCdW5pjD6DwsIxaj.GBHnfb6LoF6','ADMINISTRATOR',null,CURRENT_DATE);
...
VALUES ('Basen','Rejtana 23, Stare Miasto','Kraków', 'Basen o wymiarach 25m x 50m, podzielony na 10 torow o szerokości 2,5m. Basen o wymiarach 25m x 50m, podzielony na 10 torow o szerokości 2,5m. Basen o wymiarach 25m x 50m, podzielony na 10 torow o szerokości 2,5m. Basen o wymiarach 25m x 50m, podzielony na 10 torow o szerokości 2,5m. Basen o wymiarach 25m x 50m, podzielony na 10 torow o szerokości 2,5m.' ,'5' ,2, 'resources/img/1.jpg',0);
...
VALUES (1,1,'03/05/2018' ,'08:00', '09:00');

INSERT INTO `rezerwacja`(`id_uzytkownika`, `id_obiektu` ,`dzien_rezerwacji`,`godzina_rezerwacji`, `godzina_zakonczenia_rezerwacji`)
VALUES (1,2,'03/05/2018' ,'08:00', '09:00');

INSERT INTO `rezerwacja`(`id_uzytkownika`, `id_obiektu` ,`dzien_rezerwacji`,`godzina_rezerwacji`, `godzina_zakonczenia_rezerwacji`)
VALUES (1,3,'03/05/2018' ,'08:00', '09:00');

INSERT INTO `rezerwacja`(`id_uzytkownika`, `id_obiektu` ,`dzien_rezerwacji`,`godzina_rezerwacji`, `godzina_zakonczenia_rezerwacji`)
VALUES (1,4,'03/05/2018' ,'08:00', '09:00');
